...
**/           
        ...
        ?><img src="<?php echo get_the_post_thumbnail_url(get_the_id(),'tfs-header') ?: 'https://picsum.photos/300/200?nocache='.microtime();?>" width="300" height="200" class="tfs-imageblock"><?php
        echo '</div>';
        echo '<div class="tfs-related-grid__avatar"><img src="'.get_field('logo').'" width="32" height="32" class="tfs-related-grid__logo"></div>';
        echo '<div class="tfs-related-grid__tile-content"><h4><a href="'.get_permalink().'">'.the_title().'</a></h4></div>';
